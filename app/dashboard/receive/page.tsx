            ...
            <div className="w-48 h-48 bg-white dark:bg-[#000C22] rounded-2xl border-2 border-[#2ACED1]/30 p-4 flex items-center justify-center relative shadow-[0_0_30px_rgba(42,206,209,0.1)]">
              ...
              <div className="grid grid-cols-8 gap-[3px] w-full h-full">
                {Array.from({ length: 64 }, (_, i) => {
                  const corners = [0,1,2,5,6,7,8,16,24,13,15,23,40,48,56,57,58,61,62,63,49,41,55,47];
                  const isBlack = corners.includes(i) || Math.random() > 0.5;
                  return (
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#2ACED1] to-[#034E78] flex items-center justify-center shadow-md">
