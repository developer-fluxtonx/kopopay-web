...
const PERSONAL_SETTINGS: SettingsPageItem[] = [
  ...
  },
  {
    ...
    groupId: "personal",
    label: "Verification",
    description: "KYC phases, profile review state, and money movement access gates.",
    href: "/dashboard/settings/personal/verification",
    icon: "ShieldCheck",
    accent: "#0F766E",
    keywords: ["verification", "kyc", "identity", "compliance"],
  },
  {
    id: "personal-password",
    groupId: "personal",
    label: "Password & security",
    description: "Dedicated password reset, policy checks, and account recovery controls.",
    href: "/dashboard/settings/personal/password",
    icon: "Lock",
    accent: "#034E78",
    keywords: ["password", "security", "reset", "recovery"],
  },
  {
...
export const settingsOverviewStats: SettingsStat[] = [
  ...
  },
  {
    label: "Pages",
    value: "20",
    detail: "Three section hubs and seventeen leaf routes now live in the tree.",
    icon: "FileText",
    accent: "#034E78",
  },
  {
